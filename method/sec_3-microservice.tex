...
\begin{itemize}
    \item parameter
    \begin{itemize}
        \item \emph{GET /parameter} - Get parameters
        \item \emph{POST /parameter} - Create parameter
        \item \emph{PUT /parameter/id} - Update parameter
        \item \emph{DELETE /parameter/id} - Delete parameter
    \end{itemize}
    \item timeStep
    \begin{itemize}
        \item \emph{GET timestep} - Get TimeSteps
        \item \emph{POST timestep} - Create TimeStep
        \item \emph{PUT timestep/id} - Update TimeStep
        \item \emph{DELETE timestep/id} - Delete TimeStep
    \end{itemize}
    \item location
    \begin{itemize}
