...
\dbc{Use a more meaningful title.}
...
- Location
  ...
  \end{lstlisting}
 \dbc{Line spacing is too high. Use simple monospace format in latex.}
...
\dbc{Use a term like relational DB tham MySQL}
...
\subsection{MongoDB}
\label{sub:mongodb}
\dbc{Use a technology independent term. Same with InfluxDB. MongoDB is used for 2 section names.}
