...
These locations are taken from Google's Countries Public Dataset \cite{GoogleCountriesPublicDataset}, and consider static though out the testing, and data added to the wdias-performance-test.
