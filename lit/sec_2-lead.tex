...
As shown in the \cref{fi:lead_framework} LEAD consists of the following sub components, and it provides a distributed test bed for developing, integrating, and testing LEAD's components.
\begin{itemize}
