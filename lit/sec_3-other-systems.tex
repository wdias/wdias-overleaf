...
\dbc{Both MADIS and netCDF need to cited. Do this at the beginging for each on the systems in this chapter (while they were cited in Chap 1, it's also important to cite them in Chap 2 as well.}
...
\dbc{You are making lots of mistakes when using "ing" form of a verb. It seems checking with Grammalee didn't help either.}
